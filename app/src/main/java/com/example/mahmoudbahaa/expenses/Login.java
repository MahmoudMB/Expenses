    ...
    void SyncFromDatabase()
    {
        ...
        ValueEventListener expenseListener = new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                Log.v("id",expense.getId()+"");
                Log.v("description",expense.getDescription());
               // Log.v("category",expense.getCategory());
                //Log.v("account",expense.getAccount());
                Log.v("type",expense.getType());
                Log.v("price",expense.getPrice()+"");
                /*
                Log.v("memo",expenses.get(i).getMemo());
                Log.v("imagePath",expenses.get(i).getImagePath());
                Log.v("createdAt",expenses.get(i).getCreatedAt().getTime());
                Log.v("accountId",expenses.get(i).getAccountId());
                Log.v("categoryId",expenses.get(i).getCategoryId());
                */
            }
