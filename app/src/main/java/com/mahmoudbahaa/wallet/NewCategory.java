...
@BindView(R.id.NewCategory_Title)
        TextView NewCategory_Title;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // setTimeLineClick(0);
        ...
        {
            NewCategory_Title.setText("تعديل فـــئـــة");
            Update = true;
...
*/
    ...
    void addNewCategory(){
        ...
        {
            Snackbar snackbar = Snackbar.make(findViewById(android.R.id.content),"ادخل الاسم", Snackbar.LENGTH_LONG);
            snackbar.show();
        }
        else{
            ...
            if (!Update) {
                ...
                final Category category = new Category(seq.getSeq(), categoryName, ColorsHexa.get(CurrentColorIndex), type, false);
